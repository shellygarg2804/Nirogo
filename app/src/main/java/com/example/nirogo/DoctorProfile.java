...
public class DoctorProfile extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPost.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(DoctorProfile.this, PostUploadActivity.class);
        ...
        bubblenavigation.setNavigationChangeListener(new BubbleNavigationChangeListener() {
            ...
            public void onNavigationChanged(View view, int position) {
                ...
                if (position == 0) {
                    ...
                    startActivity(intent);
                    Animatoo.animateFade(DoctorProfile.this);
                    }

                   else if (position == 1) {
                    Intent intent= new Intent(DoctorProfile.this, AppointmentsActivity.class);
                    intent.putExtra("type","Doctor");
                    startActivity(intent);
                    Animatoo.animateFade(DoctorProfile.this);
                }
                else if (position == 2) {
                    Intent intent= new Intent(DoctorProfile.this, AmbulanceActivity.class);
                    intent.putExtra("type","Doctor");
                    startActivity(intent);
                    Animatoo.animateFade(DoctorProfile.this);
                }
